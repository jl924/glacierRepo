...
const Imageslide = () => {
  ...
  <div id="slide4" className="carousel-item relative w-full">
    ...
    <div className="flex flex-col justify-center w-[50px] py-2 gap-2 absolute">
      <a href="#slide1" className="btn btn-xs h-[50px] w-full absolute mb-[1000px] ml-[10px]">1</a>
      <a href="#slide2" className="btn btn-xs h-[50px] absolute mb-[900px] ml-[10px] w-full">2</a>
      <a href="#slide3" className="btn btn-xs h-[50px] absolute mb-[800px] ml-[10px] w-full">3</a>
      <a href="#slide4" className="btn btn-xs h-[50px] absolute mb-[700px] ml-[10px] w-full">4</a>
    </div>
  </div>
